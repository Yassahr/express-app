...
app.put('/addOneLike', (request, response) => {
    db.collection('cosplayers').updateOne({cosplayerName: request.body.cosplay, character: request.body.char,likes: request.body.likesS},{
        $set: {
...
app.delete('/deleteRapper', (request, response) => {
    db.collection('cosplayers').deleteOne({stageName: request.body.cosplay})
    .then(result => {
